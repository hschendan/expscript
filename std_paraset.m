...
global bdf bdfRTlock data_path
...
source = 'C:\Users\pzhao\Documents\MATLAB\4Files'; % Modify yours
...
% (A) same bdf for all subjects
bdfRTlock = cellstr(repmat('bdfRTlock.txt', nraw, 1)); % create an array of 52 strings {'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt' 'bdfRTlock.txt'};
