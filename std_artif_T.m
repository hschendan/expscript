...
global data_path subject ch64 artparm

    sname = [data_path{s} subject{s} '_cebM12ey.set'];       
    ...
    %clear ERP;  % Clear is to make sure that we start fresh for each subject with the EEG and ERP structures
        EEG = pop_loadset('filename', [subject{s} '_cebM12ey.set'], 'filepath', data_path{s});                
