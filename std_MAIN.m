...
clr = 1;
%                    *** set clr = 0 ***
% if have run some functions and stop in the middle.
% otherwise it will clear all the values generated by the functions in the workspace.
...
% Choose Operating systems & user's paths
if os
    std_os; 
end
