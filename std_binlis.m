...
for s=1:nraw
    ...
    if exist(sname, 'file')>0                
        ...
        values = pop_rt2text(EEG, 'eventlist',  1, 'filename', [data_path{s} EEG.setname '_RT.xls'], 'header', 'on', 'listformat', 'basic' );

        values = pop_rt2text(EEG, 'eventlist',  1, 'filename', [data_path{s} EEG.setname '_RTs.txt'], 'header', 'on', 'listformat', 'itemized' );
        values = pop_rt2text(EEG, 'eventlist',  1, 'filename', [data_path{s} EEG.setname '_RTs.xls'], 'header', 'on', 'listformat', 'itemized' );
